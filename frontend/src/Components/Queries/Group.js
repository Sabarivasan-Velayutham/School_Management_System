        ...
        <section className="pt-4">
          {groupList.map((group, index) => (
            <Link to={group.group} key={index} onClick={() => setGroup(group)}>
              <article className="mb-4 flex items-center whitespace-break-spaces rounded-md border-2 border-slate-900 bg-violet-200 p-2 hover:bg-violet-950 hover:text-slate-100 dark:border-slate-200 dark:bg-slate-950/5 dark:hover:border-slate-200 dark:hover:bg-gray-700/80 lg:p-4 ">
